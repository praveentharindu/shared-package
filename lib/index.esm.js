...
var trackPageView = function (params) {
    ...
    if (params === null || params === void 0 ? void 0 : params.href)
        window === null || window === void 0 ? void 0 : window._paq.push(['setCustomUrl', params.href]);
    if (params === null || params === void 0 ? void 0 : params.documentTitle)
        window === null || window === void 0 ? void 0 : window._paq.push(['setDocumentTitle', params.documentTitle]);
    ...
    window === null || window === void 0 ? void 0 : window._paq.push(['trackPageView']);
...
var trackEvent = function (params) {
    ...
    if (params === null || params === void 0 ? void 0 : params.documentTitle)
        window === null || window === void 0 ? void 0 : window._paq.push(['setDocumentTitle', params.documentTitle]);
    window === null || window === void 0 ? void 0 : window._paq.push(['trackEvent', params === null || params === void 0 ? void 0 : params.category, params === null || params === void 0 ? void 0 : params.action, params === null || params === void 0 ? void 0 : params.value]);
...
var trackSiteSearch = function (params) {
    ...
    if (params === null || params === void 0 ? void 0 : params.documentTitle)
        window === null || window === void 0 ? void 0 : window._paq.push(['setDocumentTitle', params.documentTitle]);
    window === null || window === void 0 ? void 0 : window._paq.push(['trackEvent', params === null || params === void 0 ? void 0 : params.keyword, params === null || params === void 0 ? void 0 : params.category, params === null || params === void 0 ? void 0 : params.resultsCount]);
...
var MatomoContext = createContext({});
var useMatomo = function () { return useContext(MatomoContext); };
var MatomoProvider = function (_a) {
    var children = _a.children, matomoConfig = _a.matomoConfig;
    var _b = useState([]), customDimensions = _b[0], setCustomDimensions = _b[1];
    useEffect(function () {
        var scriptId = 'matomo-script';
        if (!isNil_1(matomoConfig.matomoUrl) &&
            !isNil_1(matomoConfig.matomoSiteId) &&
    ...
    return jsx(MatomoContext.Provider, __assign({ value: matomo }, { children: children }));
};

export { MatomoProvider, setCustomDimension, setMatomoConfig, setMatomoTracking, trackEvent, trackPageView, trackSiteSearch, useMatomo };
