...
function setMatomoConfig(matomoConfig) {
    ...
    if (!lodash.exports.isNil(matomoConfig.matomoUrl) &&
        !lodash.exports.isNil(matomoConfig.matomoSiteId) &&
        lodash.exports.isNil(document.getElementById(scriptId))) {
    ...
    if (lodash.exports.size(matomoConfig.customDimensions) > 0) {
...
function trackPageView(params) {
    ...
    if (!!window._paq) {
        ...
        if (lodash.exports.size(window.customDimensions) > 0) {
...
export { MatomoProvider, setCustomDimension, setMatomoConfig, setMatomoTracking, trackEvent, trackLink, trackPageView, trackSiteSearch, useMatomo };
