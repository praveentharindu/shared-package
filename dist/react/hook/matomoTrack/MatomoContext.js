...
var useMatomo = function useMatomo() {
  return (0, react_1.useContext)(MatomoContext);
};
exports.useMatomo = useMatomo;
var MatomoProvider = function MatomoProvider(_a) {
  var children = _a.children,
    matomoConfig = _a.matomoConfig;
  var _b = (0, react_1.useState)([]),
    customDimensions = _b[0],
    setCustomDimensions = _b[1];
   ...
   * @param matomoInfo
   */
  var setMatomoTrack = function setMatomoTrack(matomoInfo) {
    console.log('track');
  ...
  return react_1["default"].createElement(MatomoContext.Provider, {
    value: matomo
  }, children);
};
