...
var CustomMetricContext = createContext({});
var useCustomMetric = function () { return useContext(CustomMetricContext); };
var CustomMetricProvider = function (_a) {
    var children = _a.children, metricConfig = _a.metricConfig;
    var _b = useState([]); _b[0]; _b[1];
    var _c = useState([]), customDimensions = _c[0], setCustomDimensions = _c[1];
    useEffect(function () {
    ...
    return (jsx(CustomMetricContext.Provider, __assign({ value: customMetric }, { children: children })));
};
...
export { CustomMetricProvider, setCustomDimension, setCustomMetricTracking, setMetricConfig, useCustomMetric };
